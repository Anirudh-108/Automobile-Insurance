...
public interface VehicleRepository extends JpaRepository<Vehicle, Integer> {
	...
	@Query("select v from Vehicle v JOIN v.customer c where c.id=?1 AND v.manufacturerName=?2")
	Vehicle getVehicleByManufacturerName(int custId, String manufacturerName);
